...
def predict_words(message, max_predictions):
    ...
    # return [word for word in prediction if word.startswith(message)][:max_predictions]
...
for i in range(num_test):
    start_test = time()
    print(predict_words(prefix,max_predictions))
    end_test = time()
